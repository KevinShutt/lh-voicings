$(document).ready(function() {
  ...
  //data to be given to server as JSON string before being stored in database
   song = {
            'title' : '',
  ...
  //data to be used as view model on browser only
  displayed  = [{},{},{},{},{},{},{},{},{},{},
                {},{},{},{},{},{},{},{},{},{},
                {},{},{},{},{},{},{},{},{},{},
                {},{},{},{},{},{},{},{},{},{},
  ...
  $('#save-song').submit(function(e){
    ...
    //convert song object into JSON string to be sent to server
    var newSongStr = JSON.stringify(song);
    console.log(newSongStr);

    $.ajax({
        type: "POST",
        url: "http://localhost:8080/lhv/new-song.html",
        data: newSongStr,
        dataType: 'json',
